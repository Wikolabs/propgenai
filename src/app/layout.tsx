...
export const metadata: Metadata = {
  title: "PropGenAI — Generation automatique de propositions commerciales",
  description: "PropGenAI transforme vos notes de call en proposition PDF professionnelle en 5 minutes, envoyee via DocuSign avec relances automatiques.",
};
